<template>
  <div>
    <q-btn label="Find Song" @click="getSongFromMessages" class="q-mt-md" />
...
const props = defineProps({
  messages: Array, // Accepts messages array from parent
})
...
const getSongFromMessages = async () => {
  try {
    ...
    const songSuggestion = openAiData.choices[0].message.content // e.g., "Queen - Bohemian Rhapsody"

    // 🔹 Get Spotify track ID from backend
